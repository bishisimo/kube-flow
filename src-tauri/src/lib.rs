...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::env_commands::env_view_state_list,
            commands::env_commands::env_view_state_set,
            commands::env_commands::env_view_state_delete,
            commands::orchestrator_commands::orchestrator_data_load,
            commands::orchestrator_commands::orchestrator_data_save,
            ...
            commands::kube_commands::kube_pod_exec_ack,
            ...
            commands::terminal_commands::host_shell_ack,
